<div class="px-1 py-2">
    <ul class="space-y-2">
        ...
        <li class="flex justify-between">
            <h1 class="capitalize">{{ $batiment->name === null ? "Pas d'information" : $batiment->name }}</h1>
            <h1 class="capitalize flex items-center gap-3">
                {{ $batiment->operator === null ? "Pas d'information" : $batiment->operator }}
